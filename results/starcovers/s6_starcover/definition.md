...
Result: s6_starcover   (Explicit product certificate (star_cover.py))
Complex: ∂Δ7 (S6)
...
K = ∂Δ7 is the boundary of the 7-simplex: these 8 facets are
exactly the facets of Δ7 (each omitting one vertex); K has f-vector
(8 28 56 70 56 28 8) and χ = 2, and is a closed
(5)-connected 6-manifold, hence homeomorphic to S6.
...
Total facets of K x K: 59136 = 8 x 8 pair(s) x 924 staircase
path(s) per pair = (n+1)^2 * C(2n-2, n-1) with n = 7.
